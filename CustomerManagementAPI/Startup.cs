...
namespace CustomerManagementAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //ASP.NET Core provides an instance of CustomerRepository class when an instance of ICustomerRepository is requested.
            //We are using AddScoped() method because we want the instance to be alive and available for the entire
            //scope of the given HTTP request. For another new HTTP request, a new instance of CustomerRepository
